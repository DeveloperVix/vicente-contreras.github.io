...
description: >
  ...
  <ul class="styled-list">
    <li>Monetization: Balance between ad frequency and player retention (study of basic metrics such as session length).</li>
    <li>Copyright-Free Art: The Learning Curve for Original Asset Design and Royalty-Free Audio Selection.</li>
    <li>Optimization: Physics tuning for mid-range mobile devices.</li>
    <li>Key Lesson: Early core loop validation in procedurally generated games.</li>
  </div>
